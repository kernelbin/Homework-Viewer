...
struct DLL_STRPICENV { int work[65536]; };
...
HBITMAP LoadJpegFromFile(TCHAR File[])
{
	HANDLE hFile;
	...
	picbuf = malloc(info[2] * info[3] * sizeof(struct RGB));


	

	if (decode0_JPEG(&env, FileLength, pData, 4, (char *)picbuf, 0) != 0)
	{
